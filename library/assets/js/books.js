document.addEventListener('DOMContentLoaded', () => {
  ...
  const categoriesApiUrl = 'http://localhost:5013/api/Admin/all-categories';
  const booksApiUrl = 'http://localhost:5013/api/Book/allBooks';
  const booksByCategoryApiUrl = 'http://localhost:5013/api/Book/by-category/';
